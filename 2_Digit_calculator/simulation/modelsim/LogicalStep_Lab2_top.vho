...
SIGNAL \Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\ : std_logic;
SIGNAL \Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\ : std_logic;
SIGNAL \SEG_B|logic_out[0]~0_combout\ : std_logic;
SIGNAL \SEG_B|logic_out[0]~1_combout\ : std_logic;
SIGNAL \SEG_B|logic_out[3]~4_combout\ : std_logic;
SIGNAL \SEG_B|logic_out[1]~2_combout\ : std_logic;
SIGNAL \SEG_B|logic_out[2]~3_combout\ : std_logic;
SIGNAL \Decode2|Mux5~0_combout\ : std_logic;
SIGNAL \Calculation|INST2|full_adder_sum_output~combout\ : std_logic;
SIGNAL \SEG_A|logic_out[1]~1_combout\ : std_logic;
SIGNAL \SEG_A|logic_out[2]~2_combout\ : std_logic;
SIGNAL \SEG_A|logic_out[3]~3_combout\ : std_logic;
SIGNAL \SEG_A|logic_out[0]~0_combout\ : std_logic;
...
SIGNAL \Logic_pro|Mux3~0_combout\ : std_logic;
SIGNAL \Logic_pro|Mux2~0_combout\ : std_logic;
SIGNAL \Logic_pro|Mux1~0_combout\ : std_logic;
SIGNAL \Logic_pro|Mux0~0_combout\ : std_logic;
...
\Calculation|INST2|full_adder_Carry_OUTPUT~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\ = (\sw[5]~input_o\ & ((\sw[1]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[5]~input_o\ & (\sw[0]~input_o\ & (\sw[1]~input_o\ & \sw[4]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[1]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\);

-- Location: LCCOMB_X11_Y17_N2
\Calculation|INST3|full_adder_Carry_OUTPUT~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\ = (\sw[2]~input_o\ & ((\sw[6]~input_o\) # (\Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\))) # (!\sw[2]~input_o\ & (\sw[6]~input_o\ & \Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\))
...
PORT MAP (
	datab => \sw[2]~input_o\,
	datac => \sw[6]~input_o\,
	datad => \Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\,
	combout => \Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\);

-- Location: LCCOMB_X11_Y17_N0
\SEG_B|logic_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_B|logic_out[0]~0_combout\ = (\sw[3]~input_o\ & ((\sw[7]~input_o\) # (\Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\))) # (!\sw[3]~input_o\ & (\sw[7]~input_o\ & \Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\))
...
PORT MAP (
	datab => \sw[3]~input_o\,
	datac => \sw[7]~input_o\,
	datad => \Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\,
	combout => \SEG_B|logic_out[0]~0_combout\);

-- Location: LCCOMB_X11_Y17_N26
\SEG_B|logic_out[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_B|logic_out[0]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[4]~input_o\)) # (!\pb_n[2]~input_o\ & ((\SEG_B|logic_out[0]~0_combout\)))
...
PORT MAP (
	...
	datab => \sw[4]~input_o\,
	datad => \SEG_B|logic_out[0]~0_combout\,
	combout => \SEG_B|logic_out[0]~1_combout\);

-- Location: LCCOMB_X11_Y17_N8
\SEG_B|logic_out[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_B|logic_out[3]~4_combout\ = (\sw[7]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	...
	combout => \SEG_B|logic_out[3]~4_combout\);

-- Location: LCCOMB_X11_Y17_N28
\SEG_B|logic_out[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_B|logic_out[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
PORT MAP (
	dataa => \pb_n[2]~input_o\,
	datac => \sw[5]~input_o\,
	combout => \SEG_B|logic_out[1]~2_combout\);

-- Location: LCCOMB_X11_Y17_N30
\SEG_B|logic_out[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_B|logic_out[2]~3_combout\ = (\sw[6]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \SEG_B|logic_out[2]~3_combout\);

-- Location: LCCOMB_X13_Y17_N22
\Decode2|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode2|Mux5~0_combout\ = (\SEG_B|logic_out[3]~4_combout\ & ((\SEG_B|logic_out[0]~1_combout\ & (\SEG_B|logic_out[1]~2_combout\)) # (!\SEG_B|logic_out[0]~1_combout\ & ((\SEG_B|logic_out[2]~3_combout\))))) # (!\SEG_B|logic_out[3]~4_combout\ & 
-- (\SEG_B|logic_out[2]~3_combout\ & (\SEG_B|logic_out[0]~1_combout\ $ (\SEG_B|logic_out[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \SEG_B|logic_out[0]~1_combout\,
	datab => \SEG_B|logic_out[3]~4_combout\,
	datac => \SEG_B|logic_out[1]~2_combout\,
	datad => \SEG_B|logic_out[2]~3_combout\,
	combout => \Decode2|Mux5~0_combout\);

-- Location: LCCOMB_X11_Y17_N12
\Calculation|INST2|full_adder_sum_output\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Calculation|INST2|full_adder_sum_output~combout\ = \sw[5]~input_o\ $ (\sw[1]~input_o\ $ (((\sw[0]~input_o\ & \sw[4]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[1]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \Calculation|INST2|full_adder_sum_output~combout\);

-- Location: LCCOMB_X11_Y17_N14
\SEG_A|logic_out[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_A|logic_out[1]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[1]~input_o\)) # (!\pb_n[2]~input_o\ & ((\Calculation|INST2|full_adder_sum_output~combout\)))
...
PORT MAP (
	dataa => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
	datad => \Calculation|INST2|full_adder_sum_output~combout\,
	combout => \SEG_A|logic_out[1]~1_combout\);

-- Location: LCCOMB_X11_Y17_N24
\SEG_A|logic_out[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_A|logic_out[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[6]~input_o\ $ (\Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\)))))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \Calculation|INST2|full_adder_Carry_OUTPUT~0_combout\,
	combout => \SEG_A|logic_out[2]~2_combout\);

-- Location: LCCOMB_X11_Y17_N22
\SEG_A|logic_out[3]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_A|logic_out[3]~3_combout\ = \sw[3]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[7]~input_o\ $ (\Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\)))))
...
PORT MAP (
	...
	datac => \sw[7]~input_o\,
	datad => \Calculation|INST3|full_adder_Carry_OUTPUT~0_combout\,
	combout => \SEG_A|logic_out[3]~3_combout\);

-- Location: LCCOMB_X11_Y17_N18
\SEG_A|logic_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEG_A|logic_out[0]~0_combout\ = \sw[0]~input_o\ $ (((!\pb_n[2]~input_o\ & \sw[4]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[0]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \SEG_A|logic_out[0]~0_combout\);

-- Location: LCCOMB_X13_Y17_N12
\Decode1|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode1|Mux5~0_combout\ = (\SEG_A|logic_out[1]~1_combout\ & ((\SEG_A|logic_out[0]~0_combout\ & ((\SEG_A|logic_out[3]~3_combout\))) # (!\SEG_A|logic_out[0]~0_combout\ & (\SEG_A|logic_out[2]~2_combout\)))) # (!\SEG_A|logic_out[1]~1_combout\ & 
-- (\SEG_A|logic_out[2]~2_combout\ & (\SEG_A|logic_out[3]~3_combout\ $ (\SEG_A|logic_out[0]~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \SEG_A|logic_out[1]~1_combout\,
	datab => \SEG_A|logic_out[2]~2_combout\,
	datac => \SEG_A|logic_out[3]~3_combout\,
	datad => \SEG_A|logic_out[0]~0_combout\,
	combout => \Decode1|Mux5~0_combout\);

-- Location: LCCOMB_X13_Y17_N14
\OUTPUT|DOUT_TEMP[1]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \OUTPUT|DOUT_TEMP[1]~0_combout\ = (\OUTPUT|clk_proc:COUNT[10]~q\ & (!\Decode2|Mux5~0_combout\)) # (!\OUTPUT|clk_proc:COUNT[10]~q\ & ((!\Decode1|Mux5~0_combout\)))
...
PORT MAP (
	dataa => \OUTPUT|clk_proc:COUNT[10]~q\,
	datac => \Decode2|Mux5~0_combout\,
	datad => \Decode1|Mux5~0_combout\,
	combout => \OUTPUT|DOUT_TEMP[1]~0_combout\);

-- Location: LCCOMB_X13_Y17_N6
\Decode1|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode1|Mux1~0_combout\ = (\SEG_A|logic_out[1]~1_combout\ & (!\SEG_A|logic_out[3]~3_combout\ & ((\SEG_A|logic_out[0]~0_combout\) # (!\SEG_A|logic_out[2]~2_combout\)))) # (!\SEG_A|logic_out[1]~1_combout\ & ((\SEG_A|logic_out[2]~2_combout\ & 
-- (\SEG_A|logic_out[3]~3_combout\)) # (!\SEG_A|logic_out[2]~2_combout\ & (!\SEG_A|logic_out[3]~3_combout\ & \SEG_A|logic_out[0]~0_combout\))))
...
\Decode2|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode2|Mux1~0_combout\ = (\SEG_B|logic_out[3]~4_combout\ & (((!\SEG_B|logic_out[1]~2_combout\ & \SEG_B|logic_out[2]~3_combout\)))) # (!\SEG_B|logic_out[3]~4_combout\ & ((\SEG_B|logic_out[0]~1_combout\ & ((\SEG_B|logic_out[1]~2_combout\) # 
-- (!\SEG_B|logic_out[2]~3_combout\))) # (!\SEG_B|logic_out[0]~1_combout\ & (\SEG_B|logic_out[1]~2_combout\ & !\SEG_B|logic_out[2]~3_combout\))))
...
-- Equation(s):
-- \OUTPUT|DOUT_TEMP[5]~1_combout\ = (\OUTPUT|clk_proc:COUNT[10]~q\ & ((!\Decode2|Mux1~0_combout\))) # (!\OUTPUT|clk_proc:COUNT[10]~q\ & (!\Decode1|Mux1~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \Decode1|Mux1~0_combout\,
	datac => \OUTPUT|clk_proc:COUNT[10]~q\,
	datad => \Decode2|Mux1~0_combout\,
	combout => \OUTPUT|DOUT_TEMP[5]~1_combout\);

-- Location: LCCOMB_X13_Y17_N30
\Decode2|Mux0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode2|Mux0~0_combout\ = (\SEG_B|logic_out[3]~4_combout\) # ((\SEG_B|logic_out[1]~2_combout\ & ((!\SEG_B|logic_out[2]~3_combout\) # (!\SEG_B|logic_out[0]~1_combout\))) # (!\SEG_B|logic_out[1]~2_combout\ & ((\SEG_B|logic_out[2]~3_combout\))))
...
\Decode1|Mux0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode1|Mux0~0_combout\ = (\SEG_A|logic_out[3]~3_combout\) # ((\SEG_A|logic_out[1]~1_combout\ & ((!\SEG_A|logic_out[0]~0_combout\) # (!\SEG_A|logic_out[2]~2_combout\))) # (!\SEG_A|logic_out[1]~1_combout\ & (\SEG_A|logic_out[2]~2_combout\)))
...
-- Equation(s):
-- \OUTPUT|DOUT_TEMP[6]~2_combout\ = (\OUTPUT|clk_proc:COUNT[10]~q\ & (\Decode2|Mux0~0_combout\)) # (!\OUTPUT|clk_proc:COUNT[10]~q\ & ((\Decode1|Mux0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \Decode2|Mux0~0_combout\,
	datab => \Decode1|Mux0~0_combout\,
	datac => \OUTPUT|clk_proc:COUNT[10]~q\,
...
\Logic_pro|Mux3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Logic_pro|Mux3~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[0]~input_o\ & \sw[4]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[0]~input_o\) # (\sw[4]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[0]~input_o\ $ 
-- (!\sw[4]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[0]~input_o\,
	datad => \sw[4]~input_o\,
	combout => \Logic_pro|Mux3~0_combout\);

-- Location: LCCOMB_X11_Y17_N6
\Logic_pro|Mux2~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Logic_pro|Mux2~0_combout\ = (\pb_n[1]~input_o\ & ((\sw[1]~input_o\ & ((\sw[5]~input_o\) # (!\pb_n[0]~input_o\))) # (!\sw[1]~input_o\ & (\sw[5]~input_o\ & !\pb_n[0]~input_o\)))) # (!\pb_n[1]~input_o\ & (\sw[1]~input_o\ $ (\sw[5]~input_o\ $ 
-- (!\pb_n[0]~input_o\))))
...
PORT MAP (
	...
	combout => \Logic_pro|Mux2~0_combout\);

-- Location: LCCOMB_X11_Y17_N4
\Logic_pro|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Logic_pro|Mux1~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[6]~input_o\ & \sw[2]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[6]~input_o\ $ 
-- (!\sw[2]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \Logic_pro|Mux1~0_combout\);

-- Location: LCCOMB_X11_Y17_N10
\Logic_pro|Mux0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Logic_pro|Mux0~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[7]~input_o\ & \sw[3]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[7]~input_o\) # (\sw[3]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[7]~input_o\ $ 
-- (!\sw[3]~input_o\))))
...
PORT MAP (
	...
	combout => \Logic_pro|Mux0~0_combout\);

-- Location: LCCOMB_X13_Y17_N24
\Decode2|Mux6~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode2|Mux6~0_combout\ = (\SEG_B|logic_out[1]~2_combout\ & (\SEG_B|logic_out[0]~1_combout\ & (\SEG_B|logic_out[3]~4_combout\ & !\SEG_B|logic_out[2]~3_combout\))) # (!\SEG_B|logic_out[1]~2_combout\ & (\SEG_B|logic_out[2]~3_combout\ $ 
-- (((\SEG_B|logic_out[0]~1_combout\ & !\SEG_B|logic_out[3]~4_combout\)))))
...
\Decode1|Mux6~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode1|Mux6~0_combout\ = (\SEG_A|logic_out[1]~1_combout\ & (!\SEG_A|logic_out[2]~2_combout\ & (\SEG_A|logic_out[3]~3_combout\ & \SEG_A|logic_out[0]~0_combout\))) # (!\SEG_A|logic_out[1]~1_combout\ & (\SEG_A|logic_out[2]~2_combout\ $ 
-- (((!\SEG_A|logic_out[3]~3_combout\ & \SEG_A|logic_out[0]~0_combout\)))))
...
-- Equation(s):
-- \OUTPUT|DOUT[0]~0_combout\ = (\OUTPUT|clk_proc:COUNT[10]~q\ & (\Decode2|Mux6~0_combout\)) # (!\OUTPUT|clk_proc:COUNT[10]~q\ & ((\Decode1|Mux6~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \Decode2|Mux6~0_combout\,
	datac => \OUTPUT|clk_proc:COUNT[10]~q\,
	datad => \Decode1|Mux6~0_combout\,
	combout => \OUTPUT|DOUT[0]~0_combout\);

-- Location: LCCOMB_X12_Y17_N28
\Decode1|Mux4~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode1|Mux4~0_combout\ = (\SEG_A|logic_out[2]~2_combout\ & (\SEG_A|logic_out[3]~3_combout\ & ((\SEG_A|logic_out[1]~1_combout\) # (!\SEG_A|logic_out[0]~0_combout\)))) # (!\SEG_A|logic_out[2]~2_combout\ & (\SEG_A|logic_out[1]~1_combout\ & 
-- (!\SEG_A|logic_out[3]~3_combout\ & !\SEG_A|logic_out[0]~0_combout\)))
...
\Decode2|Mux4~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode2|Mux4~0_combout\ = (\SEG_B|logic_out[3]~4_combout\ & (\SEG_B|logic_out[2]~3_combout\ & ((\SEG_B|logic_out[1]~2_combout\) # (!\SEG_B|logic_out[0]~1_combout\)))) # (!\SEG_B|logic_out[3]~4_combout\ & (!\SEG_B|logic_out[0]~1_combout\ & 
-- (\SEG_B|logic_out[1]~2_combout\ & !\SEG_B|logic_out[2]~3_combout\)))
...
-- Equation(s):
-- \OUTPUT|DOUT[2]~2_combout\ = (\OUTPUT|clk_proc:COUNT[10]~q\ & ((\Decode2|Mux4~0_combout\))) # (!\OUTPUT|clk_proc:COUNT[10]~q\ & (\Decode1|Mux4~0_combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \Decode1|Mux4~0_combout\,
	datac => \OUTPUT|clk_proc:COUNT[10]~q\,
	datad => \Decode2|Mux4~0_combout\,
	combout => \OUTPUT|DOUT[2]~2_combout\);

-- Location: LCCOMB_X13_Y17_N10
\Decode1|Mux3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode1|Mux3~0_combout\ = (\SEG_A|logic_out[1]~1_combout\ & ((\SEG_A|logic_out[2]~2_combout\ & ((\SEG_A|logic_out[0]~0_combout\))) # (!\SEG_A|logic_out[2]~2_combout\ & (\SEG_A|logic_out[3]~3_combout\ & !\SEG_A|logic_out[0]~0_combout\)))) # 
-- (!\SEG_A|logic_out[1]~1_combout\ & (!\SEG_A|logic_out[3]~3_combout\ & (\SEG_A|logic_out[2]~2_combout\ $ (\SEG_A|logic_out[0]~0_combout\))))
...
\Decode2|Mux3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode2|Mux3~0_combout\ = (\SEG_B|logic_out[1]~2_combout\ & ((\SEG_B|logic_out[0]~1_combout\ & ((\SEG_B|logic_out[2]~3_combout\))) # (!\SEG_B|logic_out[0]~1_combout\ & (\SEG_B|logic_out[3]~4_combout\ & !\SEG_B|logic_out[2]~3_combout\)))) # 
-- (!\SEG_B|logic_out[1]~2_combout\ & (!\SEG_B|logic_out[3]~4_combout\ & (\SEG_B|logic_out[0]~1_combout\ $ (\SEG_B|logic_out[2]~3_combout\))))
...
-- Equation(s):
-- \OUTPUT|DOUT[3]~3_combout\ = (\OUTPUT|clk_proc:COUNT[10]~q\ & ((\Decode2|Mux3~0_combout\))) # (!\OUTPUT|clk_proc:COUNT[10]~q\ & (\Decode1|Mux3~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \Decode1|Mux3~0_combout\,
	datac => \OUTPUT|clk_proc:COUNT[10]~q\,
	datad => \Decode2|Mux3~0_combout\,
	combout => \OUTPUT|DOUT[3]~3_combout\);

-- Location: LCCOMB_X12_Y17_N0
\Decode1|Mux2~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode1|Mux2~0_combout\ = (\SEG_A|logic_out[1]~1_combout\ & (((!\SEG_A|logic_out[3]~3_combout\ & \SEG_A|logic_out[0]~0_combout\)))) # (!\SEG_A|logic_out[1]~1_combout\ & ((\SEG_A|logic_out[2]~2_combout\ & (!\SEG_A|logic_out[3]~3_combout\)) # 
-- (!\SEG_A|logic_out[2]~2_combout\ & ((\SEG_A|logic_out[0]~0_combout\)))))
...
\Decode2|Mux2~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \Decode2|Mux2~0_combout\ = (\SEG_B|logic_out[1]~2_combout\ & (\SEG_B|logic_out[0]~1_combout\ & (!\SEG_B|logic_out[3]~4_combout\))) # (!\SEG_B|logic_out[1]~2_combout\ & ((\SEG_B|logic_out[2]~3_combout\ & ((!\SEG_B|logic_out[3]~4_combout\))) # 
-- (!\SEG_B|logic_out[2]~3_combout\ & (\SEG_B|logic_out[0]~1_combout\))))
...
-- Equation(s):
-- \OUTPUT|DOUT[4]~4_combout\ = (\OUTPUT|clk_proc:COUNT[10]~q\ & ((\Decode2|Mux2~0_combout\))) # (!\OUTPUT|clk_proc:COUNT[10]~q\ & (\Decode1|Mux2~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \Decode1|Mux2~0_combout\,
	datac => \OUTPUT|clk_proc:COUNT[10]~q\,
	datad => \Decode2|Mux2~0_combout\,
